<nav class="navbar navbar-expand-md navbar-dark bg-dark" id="headerNav">
    <div class="container-fluid">
        <div class="bg-dark rounded-circle logodisplay" style="width: 100px; height: 100px; position: absolute; top: -50px; left: 50%; transform: translate(-50%); display: flex; justify-content: center; align-items: center;">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img class="img-fluid m-2" style="width: 90px; height: 90px;" src="https://dragolets.com/files/GeneralAssets/logo.png">
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <!-- Left Side Of Navbar -->
            <ul class="navbar-nav mr-auto nav-navleft">
                <li class="nav-item">
